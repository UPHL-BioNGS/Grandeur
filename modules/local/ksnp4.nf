process KSNP4 {
    ...
    path "ksnp4/tree.parsimony.tre",       emit: tree_parsimony, optional: true
    ...
    # Format: /path/to/genome.fasta <tab> genome_ID
    ...
    # -v: verbose
    # -core: calculating core SNPs
    # -ML: estimate Maximum Likelihood tree (optional but recommended)
